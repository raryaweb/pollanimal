...
<script src="{{ asset('js/backend/ajax.googleapis.min.js')}}"></script>
  ...
  <script src="{{ asset('js/backend/vendor/d3/d3.min.js')}}"></script>
  <script src="{{ asset('js/backend/vendor/d3/d3.layout.min.js')}}"></script>
  ...
  <script src="{{ asset('js/backend/vendor/daterangepicker/moment.min.js')}}"></script>
  <script src="{{ asset('js/backend/vendor/daterangepicker/daterangepicker.js')}}"></script>
  ...
  <script src="{{ asset('js/backend/vendor/owl-carousel/owl.carousel.min.js')}}"></script>
  <script src="{{ asset('js/backend/vendor/datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
  <script src="{{ asset('js/backend/vendor/datatables/js/jquery.dataTables.min.js')}}"></script>
  <script src="{{ asset('js/backend/vendor/datatables/extensions/dataTables.bootstrap.js')}}"></script>
  ...
  <script src="{{ asset('js/backend/vendor/coolclock/coolclock.js')}}"></script>
  <script src="{{ asset('js/backend/vendor/coolclock/excanvas.js')}}"></script>      
