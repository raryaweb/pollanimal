...
?>
        ...
        <p class="text-center agent-copyright-txt">Copyright © 2017 <a href="{{ route('home') }}">Poll Animal</a> <span>All Right Reserved</span></p>
    </div>
</footer>
...
<script async src="https://maps.googleapis.com/maps/api/js?v=3&amp;key=AIzaSyBdWxkI5PyEOy429f-g-5IVY0daL_-6QlI"></script>
