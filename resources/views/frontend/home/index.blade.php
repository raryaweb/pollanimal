  ...
  text-align: center;
					...
					<div class="agent-welcome-tbl">
						<div class="agent-welcome-tbl-c">
							<nav class="agent-social-links banner-social-links">
								<ul>
									<li><a href="https://twitter.com/Pollanimal" target="_blank"><i class="fa fa-twitter"></i></a></li>
									<li><a href="https://plus.google.com/u/0/108265710207237184889" target="_blank"><i class="fa fa-google-plus"></i></a></li>
									<li><a href="https://www.facebook.com/Pollanimal-Survey-453745581712882/" target="_blank"><i class="fa fa-facebook"></i></a></li>
								</ul>
							</nav>
						</div>
					</div>
		...
		<?php $x=1;?>
		 ...
		 @foreach ($public_entries as $anketa)
			...
			<p style='word-wrap: break-word;height:65px'>{{ mb_strimwidth($anketa->description, 0, 80, "...") }}</p>
		 	<p><a href="{{ route('campaigns.answer', $anketa->id) }}" class="cusub"><i class="fa fa-book" aria-hidden="true"></i> Fill Survey</a></p>
			<p class='content'>
	...
	<?php $x++;?>
		...
		<div class="col-lg-12 col-md-12" style="text-align:center; margin-top:50px;">
			<a href="{{ url('surveys')}}" class="btn btn-primary mb-10 btn-cns">All Surveys</a>
		</div>
