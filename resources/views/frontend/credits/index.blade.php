		                                ...
		                                <tbody class="sblock">
		                                	...
		                                	<tr id="payment_options" style="display:none;">
		                                		<td colspan="3" style="text-align:center"><button id="btn_paypal" type="submit" class="btn btn-primary"><font style="vertical-align: inherit;">Paypal</font></button>
		                                			<button id="btn_bankcard" action="{!! URL::to('cardform') !!}" type="button" class="btn btn-primary" onclick="changeFormActionToCard(this);"><font style="vertical-align: inherit;">Bank Card</font></button>
		                                		</td>
		                                	</tr>                                   
		                                </tbody>
		                            </table>
