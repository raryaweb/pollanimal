                            ...
                            <div role="tabpanel">    
								...
								@if (count($entry->results))
									<div class="alert alert-danger">
										...
										<p>
											Your survey has answers, so you can't edit questions.
										</p>
								...
								@elseif ($entry->active)
									<div class="alert alert-danger">
										...
										<p>
											Your survey is <strong>active</strong>, so you can't edit questions.
										</p>

										<p>
											<a href="{{ route('campaigns.deactivate', $entry->id) }}" class="btn btn-danger">Deactivate survey</a>
										</p>
									</div>
								@endif
