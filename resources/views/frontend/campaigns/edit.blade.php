                                                        ...
                                                        @else
                                                          ...
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-body" style="color: black;">
                                                                Looks like your survey is not yet active, please click on launch to make it active.
                                                              </div>
                                                              <div class="modal-footer">
...
<a href="{{ route('campaigns.results', $entry->id) }}" class="btn btn-primary" style="border-color:#16977d!important;; background-color: #16977d!important;">Result</a>
                                            ...
                                            <div class="pull-right" style="margin-top:5px!important; margin-right:50px !important;">
                                                ...
                                                </span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;margin-left: 10px;"> Promote </font></font></button>
                                                <!-- @endif -->
                                                @if ($entry->active)
                                                <button type="submit" name="btn_launch" id="btn_launch" class="btn btn-danger disablebutton" value="0">
                                                </span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;margin-left: 10px;"> Disabled</font></font></button>
                                                @else
