                            ...
                            <div role="tabpanel">
                                ...
                                @if (count($entry->results))
                                    <div class="alert alert-danger">
                                        <h4>You can't edit questions!</h4>
                                        <p>The survey already has some answers, so you can't edit.</p>
                                        <p><a href="{{ route('campaigns.deactivate', $entry->id) }}" class="btn btn-danger">Delete results and deactivate survey.</a></p>
                                    </div>
                                @elseif ($entry->active)
                                    <div class="alert alert-danger">
                                        <h4>You can't edit questions!</h4>
                                        <p>Your survey is <strong>active</strong>, so you can't  edit questions.</p>
                                        <p><a href="{{ route('campaigns.deactivate', $entry->id) }}" class="btn btn-danger">Deactivate survey</a></p>
                                    </div>
                                @endif
